  ...
  return (
    <div className="p-4 md:p-6 max-w-4xl mx-auto space-y-8">
      <div className="flex items-center gap-3 mb-6">
         <h1 className="text-3xl font-bold text-primary">PMFBY Insurance Portal</h1>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <CardContent className="space-y-3">
            {Object.keys(enrolData).map((field) => (
              <div key={field} className="space-y-1">
                <Label className="capitalize text-xs text-muted-foreground">{field.replace('_', ' ')}</Label>
                <Input
                  className="h-9"
            ...
            <Button className="w-full mt-4 bg-green-600 hover:bg-green-700" onClick={handleEnrol}>
              Enrol Farmer
            </Button>
          </CardContent>
        </Card>
        ...
        <Card className="border-l-4 border-l-blue-500 shadow-sm">
          ...
          <CardContent className="space-y-3">
            ...
            <Button className="w-full mt-4 bg-blue-600 hover:bg-blue-700" onClick={handleClaim}>
              Submit Claim
            </Button>
          </CardContent>
        </Card>
      ...
      <Card className="border-l-4 border-l-orange-500 shadow-sm">
        ...
        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* 1. Upload DSSAT Data */}
          <div className="border border-dashed border-gray-300 rounded-lg p-6 flex flex-col items-center justify-center text-center bg-gray-50 hover:bg-gray-100 transition-colors">
