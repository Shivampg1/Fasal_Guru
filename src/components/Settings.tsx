          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              {[
                {
                  key: "weatherAlerts",
                  label: "मौसम अलर्ट / Weather Alerts",
                  desc: "Get notified about weather changes",
                },
                {
                  key: "cropAdvisory",
                  label: "फसल सलाह / Crop Advisory",
                  desc: "Receive crop-related recommendations",
                },
                {
                  key: "marketPrices",
                  label: "बाजार भाव / Market Price Updates",
                  desc: "Stay updated with market prices",
                },
                {
                  key: "smsNotifications",
                  label: "SMS सूचनाएं / SMS Notifications",
                  desc: "Receive SMS notifications",
                },
                {
