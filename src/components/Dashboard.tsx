...
const Dashboard = () => {
  ...
  const modules = [
    { id:"crop-disease", title:"Crop Disease Detection", description:"Upload crop images to detect diseases and get treatment recommendations",
      ...
      link:"https://huggingface.co/spaces/cropdiseasedetection/crop-disease-detector-app", external:true },
    ...
    { id:"weather", title:"Weather Forecast", description:"7-Day forecast + advisories",
      ...
      link:"https://weather-app-navy-nine-35.vercel.app/", external:true },
    ...
    { id:"yield-estimator", title:"Yield Estimator", description:"DSSAT-based estimation",
      ...
      link:"https://huggingface.co/spaces/cropdiseasedetection/dssat-detection-yield-prediction", external:true },
    ...
    { id:"highres-insights", title:"High-Res Crop Insights", description:"Satellite NDVI + Vegetation",
      ...
      link:"https://huggingface.co/spaces/cropdiseasedetection/satellite-crop-monitoring", external:true },
